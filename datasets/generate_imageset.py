...
def generate_iamgets(dataset=None):
    ...
    if dataset  == 'DOTA':
        ...
        trainset = r'/data-input/dal/NWPU_VHR/ImageSets/train.txt'
        valset   = r'/data-input/dal/NWPU_VHR/ImageSets/test.txt'
        testset   = r'/data-input/dal/NWPU_VHR/ImageSets/test.txt'
        img_dir = r'/data-input/dal/NWPU_VHR/AllImages'
        label_dir = r'/data-input/dal/NWPU_VHR/Annotations'
        root_dir = r'/data-input/dal/NWPU_VHR' 
